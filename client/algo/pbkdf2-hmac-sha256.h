...
void sha256_init(SHA256_CTX_HMAC *ctx);
void sha256_update(SHA256_CTX_HMAC *ctx, const uint8_t *m, uint32_t mlen);
// resets state
void sha256_final(SHA256_CTX_HMAC *ctx, uint8_t *md);
