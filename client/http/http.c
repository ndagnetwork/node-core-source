...
int test_https(void)
{
	...
	sslWrite(c, "GET /ndagnetwork/node-core-source/master/client/netdb-white.txt HTTP/1.1\r\nHost: raw.githubusercontent.com\r\nconnection: close\r\n\r\n");
	resp = sslRead(c);
...
int test_http(void)
{
	...
	tcpWrite(c, "GET /ndagnetwork/node-core-source/master/client/netdb-white.txt HTTP/1.1\r\nHost: raw.githubusercontent.com\r\nconnection: close\r\n\r\n");
	resp = tcpRead(c);
